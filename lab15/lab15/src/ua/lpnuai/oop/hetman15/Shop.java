package ua.lpnuai.oop.hetman15;
...
public class Shop
    ...
    public void start(Stage primaryStage) {
        ...
        primaryStage.setTitle("Навчальні курси");

        // Products label
        Label label = new Label("Студенти");
        ...
        TableColumn titleCol = new TableColumn("Ім'я");
        ...
        TableColumn priceCol = new TableColumn("Група");
        ...
        TableColumn qCol = new TableColumn("Вступний бал");
        ...
        TableColumn unitCol = new TableColumn("Номер телефону");
        ...
        TableColumn timeCol = new TableColumn("Рік вступу");
    ...
    private ObservableList<Product> getInitialTableData() {
        ...
        list.add(new Product("Стасюк Андрій", "108", "190", "0965494392", "17.05.2018"));
        list.add(new Product("Гетьман Соломія", "108", "190", "0965494392", "17.05.2018"));
        list.add(new Product("Петро Телішевський", "108", "180", "0965494392", "17.05.2018"));
